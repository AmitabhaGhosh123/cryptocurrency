...
export class ComparisonComponent implements OnInit {
  ...
  constructor(public route:ActivatedRoute,public router:Router,public toastr:ToastrService,public cryptoservice:CryptoService) {
  ...
  init() {
    ...
    setInterval(() => {
      ...
      localStorage.clear();
      // both currency id
      let myCoinId1 = this.route.snapshot.paramMap.get('id1');
      let myCoinId2 = this.route.snapshot.paramMap.get('id2');
      ...
      this.cryptoservice.getAllCurrency().subscribe(
        ...
        data => {
          ...
          this.timelines1.push({"hourGraph":hours1,"priceGraph":price1});
          ...
          this.timelines2.push({"hourGraph":hours2,"priceGraph":price2});

          // set data in local storage for both currency last update hours and respectivly price
